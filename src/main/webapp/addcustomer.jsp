...
<header>
	...
	<div class="container card" style=" padding-top: 50px; padding-left: 50px; padding-right: 50px;  margin-top: 60px; margin-bottom: 0px;">
		...
		<h2>New Customer</h2>
		<form id="cust" action="addcustomer" method="post">

			<div>
				<label for="name" class="red">Customer Name *</label> <input type="text" id="name" name="name" class="form-control">
			</div><br>

			<div>
				<label for="email" class="red">Customer Email *</label> <input id="email" type="email" name="email" class="form-control">
			</div><br>
